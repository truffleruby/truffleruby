...
exclude :test_encoding_names_of_default_internal, "assert_separately failed with error message"
...
exclude :test_index, "Expected Exception(Encoding::CompatibilityError) was raised, but the message doesn't match. Expected /EUC-JP and BINARY \\(ASCII-8BIT\\)/ to match \"incompatible character encodings: EUC-JP and ASCII-8BIT\"."
...
exclude :test_regexp_usascii, "<#<Encoding:US-ASCII>> expected but was <#<Encoding:ASCII-8BIT>>."
...
exclude :test_scrub_widechar, "ArgumentError: UTF-32 string byte length (1) is not a multiple of 4"
...
exclude :test_string_inspect_encoding, "<no message> (java.lang.AssertionError) from org.truffleruby.core.string.StringPrimitiveNodes$CharacterPrintablePrimitiveNode.isCharacterPrintable(StringPrimitiveNodes.java:1161)"
