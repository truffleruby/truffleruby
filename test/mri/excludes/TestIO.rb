...
exclude :test_advise, "tmpfs on Linux 6.16.12-061612-generic."
...
exclude :test_binmode_pipe, "Expected #<IO:fd 44> to be binmode?."
exclude :test_blocking_timeout, "assert_separately failed with error message"
exclude :test_cloexec, "Expected #<IO:fd 40> to be close_on_exec?."
...
exclude :test_close_read_write_separately, "Exception raised: <#<IOError: closed stream>>"
...
exclude :test_copy_stream_dup_buffer, "NameError: undefined local variable or method `it' for an instance of TestIO"
...
exclude :test_dup_timeout, "NoMethodError: undefined method `timeout=' for an instance of IO"
...
exclude :test_initialize, "Errno::EINVAL expected but nothing was raised."
...
exclude :test_path_with_pipe, "needs investigation"
...
exclude :test_recycled_fd_close, "Errno::EBADF: Bad file descriptor"
...
exclude :test_reopen_binmode, "Expected #<File:0x1458 path=/b/b/e/main/test/mri/tests/ruby/test_io.rb> to not be binmode?."
exclude :test_reopen_encoding, "<#<Encoding:EUC-JP>> expected but was <#<Encoding:UTF-8>>."
exclude :test_reopen_encoding_from_io, "<#<Encoding:UTF-8>> expected but was <#<Encoding:UTF-16LE>>."
...
exclude :test_ungetbyte_with_seek, "Errno::EINVAL: Invalid argument"
exclude :test_ungetc, "IOError expected but nothing was raised."
exclude :test_ungetc_with_seek, "Errno::EINVAL: Invalid argument"
