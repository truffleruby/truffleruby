...
exclude :test_count, "very slow: StackOverflowError Error while formatting Ruby exception: <internal:core> core/post.rb:80:in `block in p': stack level too deep (SystemStackError)"
...
exclude :test_monkey_patch_include?, "hangs"
exclude :test_pack_format_mutation, "[RuntimeError] exception expected, not #<ArgumentError: too few arguments>."
exclude :test_permutation_stack_error, "very slow; SystemStackError: stack level too deep from com.oracle.truffle.api.strings.TStringOps.validateRegionWithBaseOffset(TStringOps.java:1561)"
