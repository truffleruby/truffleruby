...
exclude :test_produce, "ArgumentError expected but nothing was raised."
exclude :test_product_new, "<0> expected but was <Infinity>."
exclude :test_s_product, "<0> expected but was <Infinity>."
...
exclude :test_stopiteration_rescue, "Expected \"<internal:core> core/enumerator.rb:164:in `next'\" to include \"test_enumerator.rb:262:\"."
