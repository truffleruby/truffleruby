exclude :test_Rational_with_invalid_exception, "ArgumentError expected but nothing was raised."
exclude :test_Rational_without_exception, "<nil> expected but was <(5/3)>."
...
exclude :test_ratsub, "ArgumentError: wrong number of arguments (given 1, expected 3)"
