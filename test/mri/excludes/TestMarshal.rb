exclude :test_change_class_name, "[TypeError] exception expected, not #<NoMethodError: undefined method `_load' for class TestMarshal::C3>."
exclude :test_change_struct, "[TypeError] exception expected, not #<NoMethodError: undefined method `intern' for nil>."
exclude :test_class_ivar, "TypeError expected but nothing was raised."
exclude :test_inconsistent_struct, "[TypeError] exception expected, not #<NoMethodError: undefined method `members' for class TestMarshal::StructOrNot>."
...
exclude :test_marshal_load_extended_class_crash, "assert_separately failed with error message"
exclude :test_marshal_load_ivar, "TestMarshal::LoadData."
exclude :test_marshal_load_r_prepare_reference_crash, "assert_separately failed with error message"
...
exclude :test_no_internal_ids, "Expected \"ERROR: truffleruby: invalid option --parser=parse.y  (Use --help for usage instructions.)\\n\" to be empty."
exclude :test_nonascii_class_instance, "Encoding::CompatibilityError: incompatible character encodings: UTF-8 and ISO-8859-1"
exclude :test_nonascii_class_module, "Cannot convert a Ruby String with BINARY encoding containing non-US-ASCII character 195 to a Java String (org.truffleruby.core.string.CannotConvertBinaryRubyStringToJavaString) from org.truffleruby.core.encoding.TStringUtils.toJavaStringOrThrow(TStringUtils.java:159)"
...
exclude :test_recursive_userdef, "Exception(RuntimeError) with message matches to /recursive\\b.*\\b_dump/."
