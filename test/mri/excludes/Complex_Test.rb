...
exclude :test_canonicalize_internal, "NoMethodError: undefined method `+' for an instance of #<Class:0x4b8>"
...
exclude :test_marshal_compatibility, "<(1+2i)> expected but was <#<Complex:0x768 @real=1, @image=2>>."
exclude :test_mul, "<(Infinity+0i)> expected but was <(Infinity+NaN*i)>."
exclude :test_polar, "TypeError: not a real"
exclude :test_rationalize, "NoMethodError: undefined method `abs' for nil"
...
exclude :test_to_r_with_float, "RangeError: can't' convert 3+0.0i into Rational"
exclude :test_to_r_with_numeric_obj, "ArgumentError: wrong number of arguments (given 1, expected 0)"
