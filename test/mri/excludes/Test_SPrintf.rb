...
exclude :"test_format_integer(% #+-00.d)", "value 0 with precision 0 should not write anything"
exclude :"test_format_integer(% #-00.d)", "value 0 with precision 0 should not write anything"
exclude :"test_format_integer(% #-020.d)", "transient(depends on libc and fails on CI): rb_sprintf(\"% #-020.d\", 2147483647)."
exclude :"test_format_integer(% #0.d)", "value 0 with precision 0 should not write anything"
exclude :"test_format_integer(%#+0.d)", "value 0 with precision 0 should not write anything"
exclude :"test_format_integer(%#+05.d)", "transient(depends on libc and fails on CI): rb_sprintf(\"%#+05.d\", 3)."
exclude :"test_format_integer(%.0d)", "value 0 with precision 0 should not write anything"
exclude :test_quote, "<\"[\\\\n]\"> expected but was <\"[\\n\" + \"]\">."
