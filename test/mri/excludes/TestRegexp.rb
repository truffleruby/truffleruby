...
exclude :test_bug_19467, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_bug_20453, "Timeout::Error expected but nothing was raised."
...
exclude :test_match_byteoffset_begin_end, "[IndexError] exception expected, not #<NoMethodError: undefined method `bytebegin' for an instance of MatchData>."
exclude :test_match_cache_atomic, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_atomic_complex, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_exponential, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_negative_look_ahead, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_negative_look_behind, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_positive_look_ahead, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_positive_look_ahead_complex, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_positive_look_behind, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_square, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_cache_with_peek_optimization, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_match_no_match_no_matchdata, "NoMethodError: undefined method `count_objects' for module ObjectSpace"
...
exclude :test_s_timeout, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_s_timeout_corner_cases, "NoMethodError: private method `timeout' called for class Regexp"
exclude :test_timeout_corner_cases, "NoMethodError: private method `timeout' called for an instance of Regexp"
exclude :test_timeout_longer_than_global, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_timeout_nil, "NoMethodError: undefined method `timeout=' for class Regexp"
exclude :test_timeout_shorter_than_global, "NoMethodError: undefined method `timeout=' for class Regexp"
