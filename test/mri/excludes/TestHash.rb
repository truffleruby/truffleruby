...
exclude :test_inspect, "<\"{a: 1, a!: 1, a?: 1}\"> expected but was <\"{:a=>1, :a!=>1, :a?=>1}\">."
...
exclude :test_inverse_hash, "<5515372325667101238> expected to be != to"
exclude :test_merge!, "FrozenError expected but nothing was raised."
exclude :test_recursive_hash_value_struct, "Exception raised: <#<SystemStackError: stack level too deep from java.lang.StringLatin1.getChars(StringLatin1.java:90)>>"
...
exclude :test_to_proc, "Expected #<Proc:0x2e38 <internal:core> core/hash.rb:529> to be lambda?."
