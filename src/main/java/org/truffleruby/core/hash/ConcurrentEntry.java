...
public final class ConcurrentEntry {
    ...
    private static final AtomicReferenceFieldUpdater<ConcurrentEntry, ConcurrentEntry> NEXT_IN_LOOKUP_UPDATER = AtomicReferenceFieldUpdater
            .newUpdater(ConcurrentEntry.class, ConcurrentEntry.class, "nextInLookup");
    private static final AtomicReferenceFieldUpdater<ConcurrentEntry, ConcurrentEntry> PREV_IN_SEQ_UPDATER = AtomicReferenceFieldUpdater
            .newUpdater(ConcurrentEntry.class, ConcurrentEntry.class, "previousInSequence");
    private static final AtomicReferenceFieldUpdater<ConcurrentEntry, ConcurrentEntry> NEXT_IN_SEQ_UPDATER = AtomicReferenceFieldUpdater
            .newUpdater(ConcurrentEntry.class, ConcurrentEntry.class, "nextInSequence");
