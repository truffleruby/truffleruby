...
public final class FreeBSDAMD64NativeConfiguration extends DefaultNativeConfiguration {
    ...
    public static void load(NativeConfiguration configuration, RubyContext context) {
        ...
        configuration.config("platform.dirent.d_name.offset", 24);
        ...
        configuration.config("platform.errno.EBADMSG", 89);
        configuration.config("platform.errno.EBADRPC", 72);
        configuration.config("platform.errno.EBUSY", 16);
        configuration.config("platform.errno.ECANCELED", 85);
        configuration.config("platform.errno.ECAPMODE", 94);
        ...
        configuration.config("platform.errno.EDOOFUS", 88);
        ...
        configuration.config("platform.errno.EIDRM", 82);
        configuration.config("platform.errno.EILSEQ", 86);
        ...
        configuration.config("platform.errno.EMULTIHOP", 90);
        ...
        configuration.config("platform.errno.ENOATTR", 87);
        ...
        configuration.config("platform.errno.ENOLINK", 91);
        configuration.config("platform.errno.ENOMEM", 12);
        configuration.config("platform.errno.ENOMSG", 83);
        ...
        configuration.config("platform.errno.ENOTCAPABLE", 93);
        ...
        configuration.config("platform.errno.ENOTRECOVERABLE", 95);
        ...
        configuration.config("platform.errno.EOPNOTSUPP", 45);
        configuration.config("platform.errno.EOVERFLOW", 84);
        configuration.config("platform.errno.EOWNERDEAD", 96);
        ...
        configuration.config("platform.errno.EPROTO", 92);
        ...
        configuration.config("platform.errno.ELAST", 97);
        ...
        configuration.config("platform.file.O_CLOEXEC", 1048576);
        configuration.config("platform.file.O_CREAT", 512);
        configuration.config("platform.file.O_EXCL", 2048);
        configuration.config("platform.file.O_NOCTTY", 32768);
        ...
        configuration.config("platform.file.AT_SYMLINK_NOFOLLOW", 512);
        ...
        configuration.config("platform.fcntl.F_DUPFD_CLOEXEC", 17);
        ...
        configuration.config("platform.fcntl.F_GETLK", 11);
        configuration.config("platform.fcntl.F_SETLK", 12);
        configuration.config("platform.fcntl.F_SETLKW", 13);
        ...
        configuration.config("platform.fcntl.F_RDAHEAD", 16);
        ...
        configuration.config("platform.socket.AF_INET6", 28);
        configuration.config("platform.socket.PF_INET6", 28);
        configuration.config("platform.socket.AF_IPX", 23);
        configuration.config("platform.socket.PF_IPX", 23);
        configuration.config("platform.socket.AF_ISDN", 26);
        configuration.config("platform.socket.PF_ISDN", 26);
        ...
        configuration.config("platform.socket.PF_KEY", 27);
        ...
        configuration.config("platform.socket.AI_NUMERICSERV", 8);
        ...
        configuration.config("platform.socket.IPV6_DSTOPTS", 50);
        configuration.config("platform.socket.IPV6_HOPLIMIT", 47);
        configuration.config("platform.socket.IPV6_HOPOPTS", 49);
        ...
        configuration.config("platform.socket.IPV6_NEXTHOP", 48);
        configuration.config("platform.socket.IPV6_PATHMTU", 44);
        configuration.config("platform.socket.IPV6_PKTINFO", 46);
        configuration.config("platform.socket.IPV6_RECVDSTOPTS", 40);
        configuration.config("platform.socket.IPV6_RECVHOPLIMIT", 37);
        configuration.config("platform.socket.IPV6_RECVHOPOPTS", 39);
        configuration.config("platform.socket.IPV6_RECVPATHMTU", 43);
        configuration.config("platform.socket.IPV6_RECVPKTINFO", 36);
        configuration.config("platform.socket.IPV6_RECVRTHDR", 38);
        configuration.config("platform.socket.IPV6_RECVTCLASS", 57);
        configuration.config("platform.socket.IPV6_RTHDR", 51);
        configuration.config("platform.socket.IPV6_RTHDRDSTOPTS", 35);
        configuration.config("platform.socket.IPV6_RTHDR_TYPE_0", 0);
        configuration.config("platform.socket.IPV6_TCLASS", 61);
        ...
        configuration.config("platform.socket.IP_MINTTL", 66);
        ...
        configuration.config("platform.socket.IP_RECVTOS", 68);
        configuration.config("platform.socket.IP_RECVTTL", 65);
        ...
        configuration.config("platform.socket.MSG_NOSIGNAL", 131072);
        ...
        configuration.config("platform.socket.SO_DOMAIN", 4121);
        ...
        configuration.config("platform.socket.SO_MAX_PACING_RATE", 4120);
        configuration.config("platform.socket.SO_OOBINLINE", 256);
        configuration.config("platform.socket.SO_PROTOCOL", 4118);
        ...
        configuration.config("platform.socket.TCP_CONGESTION", 64);
        configuration.config("platform.socket.TCP_FASTOPEN", 1025);
        configuration.config("platform.socket.TCP_INFO", 32);
        configuration.config("platform.socket.TCP_KEEPCNT", 1024);
        configuration.config("platform.socket.TCP_KEEPIDLE", 256);
        configuration.config("platform.socket.TCP_KEEPINTVL", 512);
        configuration.config("platform.socket.TCP_MAXSEG", 2);
        configuration.config("platform.socket.TCP_MD5SIG", 16);
        ...
        configuration.config("platform.process.RLIMIT_AS", 10);
        configuration.config("platform.process.RLIMIT_SBSIZE", 9);
        ...
        configuration.config("platform.clocks.CLOCK_MONOTONIC_COARSE", 12);
        configuration.config("platform.clocks.CLOCK_MONOTONIC_FAST", 12);
        configuration.config("platform.clocks.CLOCK_MONOTONIC_PRECISE", 11);
        configuration.config("platform.clocks.CLOCK_PROCESS_CPUTIME_ID", 15);
        configuration.config("platform.clocks.CLOCK_PROF", 2);
        configuration.config("platform.clocks.CLOCK_REALTIME", 0);
        configuration.config("platform.clocks.CLOCK_REALTIME_COARSE", 10);
        configuration.config("platform.clocks.CLOCK_REALTIME_FAST", 10);
        configuration.config("platform.clocks.CLOCK_REALTIME_PRECISE", 9);
        configuration.config("platform.clocks.CLOCK_SECOND", 13);
        configuration.config("platform.clocks.CLOCK_THREAD_CPUTIME_ID", 14);
        configuration.config("platform.clocks.CLOCK_UPTIME", 5);
        configuration.config("platform.clocks.CLOCK_UPTIME_FAST", 8);
        configuration.config("platform.clocks.CLOCK_UPTIME_PRECISE", 7);
        configuration.config("platform.clocks.CLOCK_VIRTUAL", 1);
        configuration.config("platform.clocks.CLOCK_BOOTTIME", 4);
        ...
        configuration.config("platform.typedef.int_fast8_t", string(context, "int"));
        configuration.config("platform.typedef.int_fast16_t", string(context, "int"));
        ...
        configuration.config("platform.typedef.uint_fast8_t", string(context, "uint"));
        configuration.config("platform.typedef.uint_fast16_t", string(context, "uint"));
        ...
        configuration.config("platform.typedef.pthread_key_t", string(context, "int"));
        configuration.config("platform.typedef.pthread_addr_t", string(context, "pointer"));
        ...
        configuration.config("platform.typedef.c_caddr_t", string(context, "pointer"));
        configuration.config("platform.typedef.blksize_t", string(context, "int"));
        configuration.config("platform.typedef.cpuwhich_t", string(context, "int"));
        configuration.config("platform.typedef.cpulevel_t", string(context, "int"));
        configuration.config("platform.typedef.cpusetid_t", string(context, "int"));
        configuration.config("platform.typedef.blkcnt_t", string(context, "long"));
        configuration.config("platform.typedef.clock_t", string(context, "int"));
        configuration.config("platform.typedef.clockid_t", string(context, "int"));
        configuration.config("platform.typedef.critical_t", string(context, "long"));
        configuration.config("platform.typedef.daddr_t", string(context, "long"));
        configuration.config("platform.typedef.dev_t", string(context, "ulong"));
        configuration.config("platform.typedef.fflags_t", string(context, "uint"));
        ...
        configuration.config("platform.typedef.id_t", string(context, "long"));
        configuration.config("platform.typedef.ino_t", string(context, "ulong"));
        configuration.config("platform.typedef.key_t", string(context, "long"));
        configuration.config("platform.typedef.lwpid_t", string(context, "int"));
        configuration.config("platform.typedef.mode_t", string(context, "ushort"));
        configuration.config("platform.typedef.accmode_t", string(context, "int"));
        ...
        configuration.config("platform.typedef.rlim_t", string(context, "long"));
        configuration.config("platform.typedef.sbintime_t", string(context, "long"));
        configuration.config("platform.typedef.segsz_t", string(context, "long"));
        ...
        configuration.config("platform.typedef.u_register_t", string(context, "ulong"));
        ...
        configuration.config("platform.typedef.cap_ioctl_t", string(context, "ulong"));
        configuration.config("platform.typedef.kpaddr_t", string(context, "ulong"));
        configuration.config("platform.typedef.kvaddr_t", string(context, "ulong"));
        configuration.config("platform.typedef.ksize_t", string(context, "ulong"));
        configuration.config("platform.typedef.kssize_t", string(context, "long"));
        configuration.config("platform.typedef.vm_offset_t", string(context, "ulong"));
        configuration.config("platform.typedef.vm_ooffset_t", string(context, "ulong"));
        configuration.config("platform.typedef.vm_paddr_t", string(context, "ulong"));
        configuration.config("platform.typedef.vm_pindex_t", string(context, "ulong"));
        configuration.config("platform.typedef.vm_size_t", string(context, "ulong"));
        configuration.config("platform.typedef.rman_res_t", string(context, "ulong"));
        configuration.config("platform.typedef.syscallarg_t", string(context, "long"));
